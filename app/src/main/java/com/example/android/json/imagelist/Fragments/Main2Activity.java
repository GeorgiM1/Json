package com.example.android.json.imagelist.Fragments;
...
public class Main2Activity extends AppCompatActivity {
    ...
    public void setViewPager (ViewPager setViewPager) {
        adapter = new PageAdapter(this.getSupportFragmentManager(), getList());
